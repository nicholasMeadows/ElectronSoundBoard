...
export class EditSoundcardComponent implements OnInit {
  ...
  save(){
    ...
    this.dialogRef.close(new SoundCard(this.soundCard.runTimeId, title, updateFilePath, category, this.soundCard.isFavorite, this.soundCard.showOnStreamDeck, this.soundCard.isCurrentlyPlaying, this.soundCard.currentVolume, this.soundCard.playOnPrimaryAudio, this.soundCard.playOnSecondaryAudio));
  }
